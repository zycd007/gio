        ...
        <div className="flex gap-2">
          ...
          {pagination.total > 0 && (
            <button
              ...
              className="px-3 py-2 rounded-lg text-sm font-medium text-slate-500 bg-white border border-slate-200 hover:bg-slate-50 hover:text-red-600 transition-all"
              title="清空所有留言"
            >
